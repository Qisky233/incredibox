<div class="addgame-wrapper" id="fetch">
	...
	<div class="fetch-games tab-container fade" id="gimcraft">
		<div class="alert alert-info alert-dismissible fade show" role="alert">More info about <a href="https://gimcraft.com/publisher/" target="_blank">GimCraft publisher</a><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>

		<form id="form-fetch-gimcraft" class="gimcraft">
			<div class="mb-3">
				<label class="form-label">Sort by</label> 
				<select name="sort" class="form-control">
					<option selected="selected" value="all">New</option>
				</select>
			</div>
			<div class="mb-3">
