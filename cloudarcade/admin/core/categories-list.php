			...
			<ul class="category-list">
				...
				if($data['totalRows'] > 0){
					foreach ($categories as $cat) {
						...
						echo '<span class="actions"><a class="editcategory" href="dashboard.php?viewpage=categories&slug=edit&id='.esc_int($cat->id).'"><i class="fa fa-pencil-alt circle" aria-hidden="true"></i></a>';
						if($can_delete_category){
							echo '<a class="remove-category text-danger" href="#" id="'.esc_int($cat->id).'"><i class="fa fa-trash circle" aria-hidden="true"></i></a>';
						}
						echo '</span>';
						echo '</div></li>';
					}
