...
$can_add_category = $login_user->hasAccess('categories', 'add');
$can_edit_category = $login_user->hasAccess('categories', 'edit');
$can_delete_category = $login_user->hasAccess('categories', 'delete');

if (isset($_GET['slug'])){
	if($_GET['slug'] === 'edit' && $can_edit_category){
