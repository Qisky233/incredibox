...
$can_add_page = $login_user->hasAccess('pages', 'add');
$can_edit_page = $login_user->hasAccess('pages', 'edit');
$can_delete_page = $login_user->hasAccess('pages', 'delete');
					...
					<td>
						<span class="actions">
							<?php if($can_edit_page){ ?>
								<a class="editpage" href="dashboard.php?viewpage=pages&slug=edit&id=<?php echo esc_int($page->id)?>" id="<?php echo esc_int($page->id)?>"><i class="fa fa-pencil-alt circle" aria-hidden="true"></i></a>
							<?php } ?>
							<?php if($can_delete_page){ ?>
								<a class="deletepage" href="#" id="<?php echo esc_int($page->id)?>"><i class="fa fa-trash circle" aria-hidden="true"></i></a>
							<?php } ?>
						</span>
					</td>
				</tr>
